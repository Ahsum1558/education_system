...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="studentTypeAddModal" tabindex="-1" aria-labelledby="studentTypeAddModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="studentTypeAddModal">Add New Student Type</h5>
