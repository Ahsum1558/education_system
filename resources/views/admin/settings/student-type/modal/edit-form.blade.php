...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="studentTypeEditModal" tabindex="-1" aria-labelledby="studentTypeEditModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="studentTypeEditModal">Update Student Type</h5>
      ...
      <div class="modal-footer">
        <button type="reset" class="btn btn-warning d-none" data-dismiss="modal" id="reset">Reset</button>
